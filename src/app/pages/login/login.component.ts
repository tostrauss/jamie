      ...
      <div class="w-full max-w-md bg-[#2e2e42] rounded-[28px] p-8 shadow-2xl border border-white/5 relative z-10 animate-zoom-in">
          ...
          @if (!isLoginMode()) {
            <div class="space-y-1.5 animate-slide-down">
              ...
              <div class="relative">
                ...
                <svg class="w-5 h-5 text-gray-500 absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-6 text-center">
          <button 
            ...
            <span class="text-[#ff7043] font-semibold">
        ...
        <div class="space-y-3">
          ...
          <p class="text-[10px] text-gray-500 text-center">Social Login kommt bald!</p>
        </div>
      </div>
