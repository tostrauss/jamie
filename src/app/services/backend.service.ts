...
export class BackendService {
  ...
  private readonly mockGroups: ActivityGroup[] = [
    {
      id: '1',
  ...
  // In einer echten App würden wir hier fetch() benutzen und den State updaten
  groups = signal<ActivityGroup[]>(this.mockGroups);
  categoriesSig = signal<Category[]>(this.categories);
  ...
  // Simuliert den Join-Request an das Backend
